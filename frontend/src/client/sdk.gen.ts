 ...
 */
export const projectsModifyTaskAssignment = <ThrowOnError extends boolean = false>(options: Options<ProjectsModifyTaskAssignmentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<ProjectsModifyTaskAssignmentResponses, ProjectsModifyTaskAssignmentErrors, ThrowOnError>({
 ...
 */
export const projectsDeleteUserTasks = <ThrowOnError extends boolean = false>(options: Options<ProjectsDeleteUserTasksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ProjectsDeleteUserTasksResponses, ProjectsDeleteUserTasksErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const projectsGetLineItemAuditLogsRoute = <ThrowOnError extends boolean = false>(options: Options<ProjectsGetLineItemAuditLogsRouteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ProjectsGetLineItemAuditLogsRouteResponses, ProjectsGetLineItemAuditLogsRouteErrors, ThrowOnError>({
        responseTransformer: projectsGetLineItemAuditLogsRouteResponseTransformer,
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const projectsGetLineItemMessageAuditLogsRoute = <ThrowOnError extends boolean = false>(options: Options<ProjectsGetLineItemMessageAuditLogsRouteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ProjectsGetLineItemMessageAuditLogsRouteResponses, ProjectsGetLineItemMessageAuditLogsRouteErrors, ThrowOnError>({
        responseTransformer: projectsGetLineItemMessageAuditLogsRouteResponseTransformer,
        security: [
            {
                scheme: 'bearer',
                type: 'http'
