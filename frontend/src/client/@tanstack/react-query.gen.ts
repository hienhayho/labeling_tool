...
export const projectsGetDashboardUserQueryKey = (options?: Options<ProjectsGetDashboardUserData>) => createQueryKey('projectsGetDashboardUser', options);

/**
 * Get User Dashboard Data
 * Get dashboard statistics for current user projects.
 */
export const projectsGetDashboardUserOptions = (options?: Options<ProjectsGetDashboardUserData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await projectsGetDashboardUser({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: projectsGetDashboardUserQueryKey(options)
    });
};
 ...
 * Modify task assignment for a user in a project.
 */
export const projectsModifyTaskAssignmentMutation = (options?: Partial<Options<ProjectsModifyTaskAssignmentData>>): UseMutationOptions<ProjectsModifyTaskAssignmentResponse, ProjectsModifyTaskAssignmentError, Options<ProjectsModifyTaskAssignmentData>> => {
    const mutationOptions: UseMutationOptions<ProjectsModifyTaskAssignmentResponse, ProjectsModifyTaskAssignmentError, Options<ProjectsModifyTaskAssignmentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await projectsModifyTaskAssignment({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
/**
 * Delete User Tasks
 * Delete all unlabeled tasks for a specific user in a project.
 */
export const projectsDeleteUserTasksMutation = (options?: Partial<Options<ProjectsDeleteUserTasksData>>): UseMutationOptions<ProjectsDeleteUserTasksResponse, ProjectsDeleteUserTasksError, Options<ProjectsDeleteUserTasksData>> => {
    const mutationOptions: UseMutationOptions<ProjectsDeleteUserTasksResponse, ProjectsDeleteUserTasksError, Options<ProjectsDeleteUserTasksData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await projectsDeleteUserTasks({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const projectsUpdateLineItemMessageQueryKey = (options: Options<ProjectsUpdateLineItemMessageData>) => createQueryKey('projectsUpdateLineItemMessage', options);

/**
 * Update Line Item Message
 * Update a line item message with new content and role.
 */
export const projectsUpdateLineItemMessageOptions = (options: Options<ProjectsUpdateLineItemMessageData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await projectsUpdateLineItemMessage({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: projectsUpdateLineItemMessageQueryKey(options)
    });
};
 ...
 * Update a line item message with new content and role.
 */
export const projectsUpdateLineItemMessageMutation = (options?: Partial<Options<ProjectsUpdateLineItemMessageData>>): UseMutationOptions<ProjectsUpdateLineItemMessageResponse, ProjectsUpdateLineItemMessageError, Options<ProjectsUpdateLineItemMessageData>> => {
    const mutationOptions: UseMutationOptions<ProjectsUpdateLineItemMessageResponse, ProjectsUpdateLineItemMessageError, Options<ProjectsUpdateLineItemMessageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await projectsUpdateLineItemMessage({
                ...options,
                ...localOptions,
...
export const projectsGetLineItemAuditLogsRouteQueryKey = (options: Options<ProjectsGetLineItemAuditLogsRouteData>) => createQueryKey('projectsGetLineItemAuditLogsRoute', options);

/**
 * Get Line Item Audit Logs
 * Get audit logs for line items in a project
 */
export const projectsGetLineItemAuditLogsRouteOptions = (options: Options<ProjectsGetLineItemAuditLogsRouteData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await projectsGetLineItemAuditLogsRoute({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: projectsGetLineItemAuditLogsRouteQueryKey(options)
    });
};

export const projectsGetLineItemAuditLogsRouteInfiniteQueryKey = (options: Options<ProjectsGetLineItemAuditLogsRouteData>): QueryKey<Options<ProjectsGetLineItemAuditLogsRouteData>> => createQueryKey('projectsGetLineItemAuditLogsRoute', options, true);

/**
 * Get Line Item Audit Logs
 * Get audit logs for line items in a project
 */
export const projectsGetLineItemAuditLogsRouteInfiniteOptions = (options: Options<ProjectsGetLineItemAuditLogsRouteData>) => {
    return infiniteQueryOptions<ProjectsGetLineItemAuditLogsRouteResponse, ProjectsGetLineItemAuditLogsRouteError, InfiniteData<ProjectsGetLineItemAuditLogsRouteResponse>, QueryKey<Options<ProjectsGetLineItemAuditLogsRouteData>>, number | Pick<QueryKey<Options<ProjectsGetLineItemAuditLogsRouteData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ProjectsGetLineItemAuditLogsRouteData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: projectsGetLineItemAuditLogsRouteInfiniteQueryKey(options)
    });
};

export const projectsGetLineItemMessageAuditLogsRouteQueryKey = (options: Options<ProjectsGetLineItemMessageAuditLogsRouteData>) => createQueryKey('projectsGetLineItemMessageAuditLogsRoute', options);

/**
 * Get Line Item Message Audit Logs
 * Get audit logs for line item messages in a project
 */
export const projectsGetLineItemMessageAuditLogsRouteOptions = (options: Options<ProjectsGetLineItemMessageAuditLogsRouteData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await projectsGetLineItemMessageAuditLogsRoute({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: projectsGetLineItemMessageAuditLogsRouteQueryKey(options)
    });
};

export const projectsGetLineItemMessageAuditLogsRouteInfiniteQueryKey = (options: Options<ProjectsGetLineItemMessageAuditLogsRouteData>): QueryKey<Options<ProjectsGetLineItemMessageAuditLogsRouteData>> => createQueryKey('projectsGetLineItemMessageAuditLogsRoute', options, true);

/**
 * Get Line Item Message Audit Logs
 * Get audit logs for line item messages in a project
 */
export const projectsGetLineItemMessageAuditLogsRouteInfiniteOptions = (options: Options<ProjectsGetLineItemMessageAuditLogsRouteData>) => {
    return infiniteQueryOptions<ProjectsGetLineItemMessageAuditLogsRouteResponse, ProjectsGetLineItemMessageAuditLogsRouteError, InfiniteData<ProjectsGetLineItemMessageAuditLogsRouteResponse>, QueryKey<Options<ProjectsGetLineItemMessageAuditLogsRouteData>>, number | Pick<QueryKey<Options<ProjectsGetLineItemMessageAuditLogsRouteData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ProjectsGetLineItemMessageAuditLogsRouteData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: projectsGetLineItemMessageAuditLogsRouteInfiniteQueryKey(options)
    });
};