...
export const projectsUpdateLineItemMessageResponseTransformer = async (data: any): Promise<ProjectsUpdateLineItemMessageResponse> => {
    data = lineItemMessageReadSchemaResponseTransformer(data);
    return data;
};

const lineItemAuditLogReadSchemaResponseTransformer = (data: any) => {
    data.timestamp = new Date(data.timestamp);
    return data;
};

const auditLogsPublicSchemaResponseTransformer = (data: any) => {
    data.data = data.data.map((item: any) => {
        return lineItemAuditLogReadSchemaResponseTransformer(item);
    });
    return data;
};

export const projectsGetLineItemAuditLogsRouteResponseTransformer = async (data: any): Promise<ProjectsGetLineItemAuditLogsRouteResponse> => {
    data = auditLogsPublicSchemaResponseTransformer(data);
    return data;
};

export const projectsGetLineItemMessageAuditLogsRouteResponseTransformer = async (data: any): Promise<ProjectsGetLineItemMessageAuditLogsRouteResponse> => {
    data = auditLogsPublicSchemaResponseTransformer(data);
    return data;
};